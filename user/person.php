...
<div class="fixed-title"><h2>person profile</h2></div>
...
"<div><img src='../crop/user_photos/"+personPhoto+".png' width='128' height='96'></div><div>"+personName+"</div><div>"+personOnlineStatus+"</div>"
